...
- **1.2 (13.09.2026):** Nachtrag nach dem Start. Auf Gabriels Vorgabe nennt keine Seite und keine Mail mehr eine Stundenfrist („zeitnah" statt „binnen 48 Stunden") oder den Monatsdeckel; der Deckel wirkt technisch weiter. Die Werkstatt ist nicht als n8n-Erweiterung, sondern als eigener kleiner Docker-Dienst gebaut (Repo `stilprobe-automatik`, Ordner `werkstatt/`, Runbook `docs/werkstatt.md`): Sie legt Entwurf und Prüfnotiz per IMAP ins Postfach und versendet selbst nichts; senden.php unterschreibt jede Einreichung, damit niemand einen Block von außen einschleust. Abschnitte 1–13 bleiben als ursprünglicher Plan stehen.
